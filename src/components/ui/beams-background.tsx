...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function resetBeam(beam: Beam, index: number, totalBeams: number) {
            ...
            beam.hue = 240 + (index * 10) / totalBeams;
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            gradient.addColorStop(0, `hsla(${beam.hue}, 100%, 5%, 40)`);
            gradient.addColorStop(
                0.1,
                `hsla(${beam.hue}, 85%, 80%, ${pulsingOpacity * 0.5})`
            );
            gradient.addColorStop(
                0.4,
                `hsla(${beam.hue}, 85%, 80%, ${pulsingOpacity})`
            );
            gradient.addColorStop(
                0.6,
                `hsla(${beam.hue}, 85%, 80%, ${pulsingOpacity})`
            ...
            gradient.addColorStop(1, `hsla(${beam.hue}, 85%, 80%, 0)`);
